...
import type { QuestionsByTopic } from '../types'

interface TopicsSelectionProps {
  topics: string[]
  selectedTopics: string[]
  allQuestionsByTopic: QuestionsByTopic
  onTopicToggle: (topicName: string, checked: boolean) => void
  totalQuestions: number
}

function TopicsSelection({ topics, selectedTopics, allQuestionsByTopic, onTopicToggle, totalQuestions }: TopicsSelectionProps) {
  return (
