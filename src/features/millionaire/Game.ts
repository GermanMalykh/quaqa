...
export class Game {
  ...
  private readonly prizeLevels = [
    ...
    8000,     // 8
    16000,    // 9
    32000,    // 10 (вторая несгораемая сумма)
    64000,    // 11
    125000,   // 12
    250000,   // 13
    500000,   // 14
  ...
  selectAnswer(answerIndex: number): boolean {
    ...
    if (isCorrect) {
      ...
      // Если на 10-14 - получаем 32000 (вторая несгораемая сумма)
      if (this.currentQuestionIndex < 5) {
        ...
        // Неправильный ответ на вопросах 10-14 - получаем 32000 (вторая несгораемая сумма)
        this.score = 32000
      }
